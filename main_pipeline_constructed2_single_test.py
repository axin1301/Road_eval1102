...
import sys
import mapcompare_GE_constructed2_single_test
import average_statistics_constructed2

if __name__ == '__main__':

    mapcompare_GE_constructed2_single_test.main()
    # mapcompare_GE_0001.main()
    average_statistics_constructed2.main()